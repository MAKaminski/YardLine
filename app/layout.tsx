...
const POSTHOG_KEY = process.env.NEXT_PUBLIC_POSTHOG_KEY || 'phc_umeUfQQMZPzAsQvFV4lNVGATHUrTsAj4Gp9BdJMukqg'
...
posthog.init(${JSON.stringify(POSTHOG_KEY)},{api_host:${JSON.stringify(POSTHOG_HOST)},capture_pageview:'history_change',capture_pageleave:true,persistence:'localStorage+cookie',autocapture:true})`
